export const selectClasses = {
  container:
    "relative mx-auto w-full flex items-center justify-end box-border cursor-pointer border border-gray-600 rounded bg-gray-800 text-base leading-snug outline-none",
  ...
  search:
    "w-full absolute inset-0 outline-none focus:ring-0 appearance-none box-border border-0 text-base font-sans bg-gray-800 rounded pl-3.5 h-8",
  tags: "flex-grow flex-shrink flex flex-wrap items-center mt-1 pl-2",
  tag: "bg-gray-600 text-white text-sm font-semibold py-0.5 pl-2 rounded mr-1 mb-1 flex items-center whitespace-nowrap",
  ...
  tagsSearch:
    "absolute inset-0 border-0 outline-none focus:ring-0 appearance-none p-0 bg-gray-800 text-base font-sans box-border w-full",
