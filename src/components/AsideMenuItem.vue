...
const asideMenuItemInactiveStyle = computed(() => theme.asideMenuItemInactiveStyle)
...
const exactActiveClass = computed(() => secondaryMenu.value ? null : theme.asideMenuItemActiveBgStyle)
